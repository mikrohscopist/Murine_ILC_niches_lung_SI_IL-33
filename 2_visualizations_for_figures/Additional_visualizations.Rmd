---
title: "Additional_visualizations"
author: "Sandy Kroh"
...
Show ridge plot of NK cells/ILC1s/ILC3s

```{r, fig.width=2, fig.height=3}

SO.lung.sub <- subset(SO.lung, subset = AL3 == c("NK cells/ILC1s"))


colfunc <- colorRampPalette(c("darkcyan", "green", "yellow", "magenta", "purple"))


fetched_data <- FetchData(SO.lung.sub, 
                        vars = c("Dataset",
                                 "AL2",
                                 "AL3",
                                 "Location_Center_X", 
