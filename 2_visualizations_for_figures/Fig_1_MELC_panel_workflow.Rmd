...
```{r Figure_1_Main, fig.width=9, fig.height=13.4}
...
```{r Suppl_Figure_1, fig.width=9, fig.height=16.8}
...
```{r Suppl_Figure_2, fig.height=12.3, fig.width=9}
