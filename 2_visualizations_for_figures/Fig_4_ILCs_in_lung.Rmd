...
```{r Figure_4_Main, fig.width=9, fig.height=11.9}
...
```{r Suppl_Figure_3, fig.height=8.35, fig.width=9}

img_plot_bpc
```

```{r Suppl_Figure_4, fig.height=8.5, fig.width=9}

# Display the plot
print(img_plot_mye)
```

```{r Suppl_Figure_7, fig.width=9, fig.height=13.2}

ggarrange(img_plot_bec, "NONE", img_plot_ly, ncol = 1, nrow = 3, heights = c(8.1, 0.2, 4.9), labels = c("A", "",  "B"))
```

```{r Suppl_Figure_8, fig.width=9, fig.height=4}
