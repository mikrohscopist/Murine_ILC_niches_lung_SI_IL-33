...
```
## Warning in vrSpatialPlotImage(g, assay, background, scale.image, spatial =
## spatial, : The use of 'background' is deprecated, please use 'spatial' to call
## spatial coordinate systems and 'channel' to get channels of associated images.
```

```
## Warning in vrSpatialPlotImage(g, assay, background, scale.image, spatial =
## spatial, : Please use 'background.color' to draw spatial plots with custom
...
<img src="import_VoltRon_Lung_files/figure-html/unnamed-chunk-8-2.png" width="100%" style="display: block; margin: auto;" />
...
<img src="import_VoltRon_Lung_files/figure-html/unnamed-chunk-8-3.png" width="100%" style="display: block; margin: auto;" />
...
<img src="import_VoltRon_Lung_files/figure-html/unnamed-chunk-8-4.png" width="100%" style="display: block; margin: auto;" />
...
<img src="import_VoltRon_Lung_files/figure-html/unnamed-chunk-8-5.png" width="100%" style="display: block; margin: auto;" />
